...
### Resultaten
In aframe kunnen verschillende werelden gecreërd worden. Wij hebben voor de spelers een bos in aframe gemaakt. Een bos bevat natuurlijk veel bomen. Verder wat je kan toevoegen zijn stenen, vogels, struiken ect. Voordaty je die elementen in een aframe wereld gaat plaatsen, moet je ze hebben gemaakt. Wij hebben ervoor gekozen om die elementen in [Blender](https://www.blender.org/about/) te maken. Waarom Blender? Het is volgens de meeste websites de beste gratis 3D software en andere reden is, dat het mogelijk is om gltf-bestanden te exporteren, want na het maken van een object in [Blender](https://www.blender.org/about/) is het nodig om het bestand naar gltf-type te exporteren. 
